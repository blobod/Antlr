...
public class languageParser extends Parser {
	...
	public static final int
		...
		TXT_TYPE=32, BOOL_TYPE=33, ASSIGN=34, INT=35, TXT=36, BOOL=37, TRUE=38, 
		FALSE=39, ID=40, WS=41, COMMENT=42, LINE_COMMENT=43;
	public static final int
		RULE_language = 0, RULE_declaration = 1, RULE_stmts = 2, RULE_stmt = 3, 
		RULE_equation = 4, RULE_conditional_statement = 5, RULE_if_statment = 6, 
		...
		RULE_lesserORequal = 17, RULE_isNOTequal = 18, RULE_function_declaration = 19, 
		RULE_param = 20, RULE_type_definition = 21, RULE_int_type = 22, RULE_double_type = 23, 
		RULE_text_type = 24, RULE_bool_type = 25, RULE_value = 26, RULE_iDorVALUE = 27;
	private static String[] makeRuleNames() {
		return new String[] {
			"language", "declaration", "stmts", "stmt", "equation", "conditional_statement", 
			"if_statment", "iterative_statement", "for_loop", "while_loop", "forever_loop", 
			"condition", "idORvalue_condition", "greather", "lesser", "equal", "greatherORequal", 
			"lesserORequal", "isNOTequal", "function_declaration", "param", "type_definition", 
			"int_type", "double_type", "text_type", "bool_type", "value", "iDorVALUE"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "TXT", "BOOL", "TRUE", "FALSE", "ID", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public final LanguageContext language() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF) | (1L << FOR) | (1L << WHILE) | (1L << FOREVER) | (1L << VOID) | (1L << TYPE) | (1L << INT_TYPE) | (1L << DOUBLE_TYPE) | (1L << TXT_TYPE) | (1L << BOOL_TYPE) | (1L << INT) | (1L << TXT) | (1L << BOOL) | (1L << ID))) != 0)) {
				{
				{
				setState(56);
				declaration();
	...
	public static class EquationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).enterEquation(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).exitEquation(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof languageVisitor ) return ((languageVisitor<? extends T>)visitor).visitEquation(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class If_statmentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).enterIf_statment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).exitIf_statment(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof languageVisitor ) return ((languageVisitor<? extends T>)visitor).visitIf_statment(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final If_statmentContext if_statment() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_if_statment);
		try {
			setState(113);
			_errHandler.sync(this);
	...
	public final Type_definitionContext type_definition() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_type_definition);
		try {
			setState(226);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public static class Int_typeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).enterInt_type(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).exitInt_type(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof languageVisitor ) return ((languageVisitor<? extends T>)visitor).visitInt_type(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Int_typeContext int_type() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_int_type);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(228);
	...
	public static class Double_typeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).enterDouble_type(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).exitDouble_type(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof languageVisitor ) return ((languageVisitor<? extends T>)visitor).visitDouble_type(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Double_typeContext double_type() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_double_type);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(233);
	...
	public static class Text_typeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).enterText_type(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof languageListener ) ((languageListener)listener).exitText_type(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instance